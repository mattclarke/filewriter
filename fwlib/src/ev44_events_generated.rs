...
pub fn root_as_event_44_message(buf: &[u8]) -> Result<Event44Message, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_event_44_message(buf: &[u8]) -> Result<Event44Message, flatbuffers::InvalidFlatbuffer> {
